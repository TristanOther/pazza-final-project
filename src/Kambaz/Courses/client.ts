...
export const createEnrollmentForCourse = async (courseId: string, userId: string) => {
  const response = await axiosWithCredentials.post(`${COURSES_API}/${courseId}/enrollments/${userId}`);
  return response.data;
};
